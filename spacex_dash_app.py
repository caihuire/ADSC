...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All':
        ...
        fig = px.pie(filtered_df, names = 'Launch Site',hole=.3,title = 'Total Success Launches By Site')
        return fig
    else:
        filtered_df  = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig = px.pie(filtered_df, names = 'class',hole=.3,title = f'Total Success Launches for site {entered_site}')
        return fig
# TASK 4:
...
def update_scattergraph(entered_site,payload_slider):
    ...
    if (entered_site == 'All'):
        ...
        fig = px.scatter(
            filtered_df2[mask], x="Payload Mass (kg)", y="class",
